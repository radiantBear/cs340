-- CS340 Portfolio Project - Procedure Language Queries
-- This sql file contains the Procedure Language queries used to safely manipulate AppointmentServices data
...
-- #############################
-- RESET DATABASE (Essentially the same as the DDL.sql)
-- #############################
